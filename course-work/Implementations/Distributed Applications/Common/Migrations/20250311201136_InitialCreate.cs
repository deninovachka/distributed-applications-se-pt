        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DoctorSpecialization = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmployeePosition = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GlassesType = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    SphOD = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    CylOD = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    AxOD = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    SphOS = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    CylOS = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    AxOS = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
